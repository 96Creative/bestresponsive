...
?>
    ...
    <div id="four-column-wrapper" class="wrappers"><div class="clearfix">
        ...
        <div id="four-column-two" class="grid_3"><div class="section">
          <?php print render($page['four_column_two']); ?>
        </div></div>
        
        <div id="four-column-three" class="grid_3"><div class="section">
          <?php print render($page['four_column_three']); ?>
        </div></div>
        
        <div id="four-column-four" class="grid_3"><div class="section">
